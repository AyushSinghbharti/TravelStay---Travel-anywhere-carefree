      ...
      <Animated.View style={defaultStyles.footer} entering={SlideInDown.delay(200)}>
        <View
          ...
          <TouchableOpacity style={[styles.footerText]}>
            <Text style={[styles.footerPrice, {fontSize: 20}]}>€{listing.price}</Text>
            <Text style={[styles.footerPrice, {fontSize: 10}]}>/night</Text>
          </TouchableOpacity>

          <TouchableOpacity style={[defaultStyles.btn, { paddingRight: 20, paddingLeft: 20, elevation: 50 }]}>
